from asteroid_odyssey.api.generated.agents.asteroid_agents_api_client.models import CreateWorkflowRequest, CreateWorkflowRequestFields, CreateWorkflowRequestProvider
...
workflows = [
    ...
    CreateWorkflowRequest(
        ...
        prompts=[
            "I want to get an overall view of recent world events. In order to do this, can you go to a news website and choose a headline. Then, can you look at other news websites and summarise the same headline from different perspectives."
        ],
        provider=CreateWorkflowRequestProvider.ANTHROPIC
    ),
]
